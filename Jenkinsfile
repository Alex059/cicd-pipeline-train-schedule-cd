                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        removePrefix: 'dist/',
                                        remoteDirectory: '/tmp',
                                        execCommand: 'sudo $(which systemctl) stop train-schedule && rm -rf /opt/train-schedule/* && unzip /tmp/trainSchedule.zip -d /opt/train-schedule && sudo $(which systemctl) start train-schedule'
                                    )
                                ]
                            )
                        ]
